import {
  Portal
} from "./chunk-RKWNWER4.js";
import {
  useFormControlContext,
  useInput
} from "./chunk-6RLQJOTP.js";
import {
  generateUtilityClass,
  generateUtilityClasses
} from "./chunk-QW45IG3P.js";
import {
...
} from "./chunk-3RADCTKJ.js";
import {
  clamp_default,
  composeClasses,
  init_formatMuiErrorMessage
} from "./chunk-KXVSEG6I.js";
import {
  clsx_default,
  init_clsx
...
function useSelect(props) {
  ...
  const optionValues = React6.useMemo(() => Array.from(options.keys()), [options]);
  const getOptionByValue = React6.useCallback((valueToGet) => {
  ...
  const isItemDisabled = React6.useCallback((valueToCheck) => {
    var _option$disabled;
    const option = getOptionByValue(valueToCheck);
    return (_option$disabled = option == null ? void 0 : option.disabled) != null ? _option$disabled : false;
  }, [getOptionByValue]);
  const stringifyOption = React6.useCallback((valueToCheck) => {
    const option = getOptionByValue(valueToCheck);
    if (!option) {
      return "";
    }
  ...
  const controlledState = React6.useMemo(() => ({
    selectedValues: value,
    open: openProp
  }), [value, openProp]);
  const getItemId = React6.useCallback((itemValue) => {
    var _options$get;
    return (_options$get = options.get(itemValue)) == null ? void 0 : _options$get.id;
  }, [options]);
  const handleSelectionChange = React6.useCallback((event, newValues) => {
    if (multiple) {
  ...
  const handleHighlightChange = React6.useCallback((event, newValue) => {
    onHighlightChange == null || onHighlightChange(event, newValue != null ? newValue : null);
  }, [onHighlightChange]);
  const handleStateChange = React6.useCallback((event, field, fieldValue) => {
    if (field === "open") {
  ...
  const useListParameters = {
    ...
    reducerActionContext: React6.useMemo(() => ({
      multiple
    }), [multiple]),
    items: optionValues,
  ...
  const getOptionMetadata = React6.useCallback((optionValue) => getOptionByValue(optionValue), [getOptionByValue]);
  ...
  const contextValue = React6.useMemo(() => _extends({}, listContextValue, compoundComponentContextValue), [listContextValue, compoundComponentContextValue]);
  let selectValue;
  if (props.multiple) {
...
var TransitionContext = React19.createContext(null);
if (true) {
...
function useTransitionStateManager() {
  const transitionContext = React20.useContext(TransitionContext);
...
function useTransitionTrigger(requestEnter) {
  const [exitTransitionFinished, setExitTransitionFinished] = React21.useState(true);
  const hasPendingExitTransition = React21.useRef(false);
  const registeredTransitions = React21.useRef(0);
  const [hasTransition, setHasTransition] = React21.useState(false);
  const previousRequestEnter = React21.useRef(requestEnter);
  React21.useEffect(() => {
  ...
  const handleExited = React21.useCallback(() => {
    hasPendingExitTransition.current = false;
    setExitTransitionFinished(true);
  }, []);
  const registerTransition = React21.useCallback(() => {
...
var PopupContext = React22.createContext(null);
if (true) {
...
var Popup = React23.forwardRef(function Popup2(props, forwardedRef) {
  var _slots$root;
  const {
    anchor: anchorProp,
    children,
  ...
  const popupContextValue = React23.useMemo(() => ({
    placement: finalPlacement
  }), [finalPlacement]);
...
var Slider = React35.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime26.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime25.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime25.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min2 && mark.value <= max2).map((mark, index2) => {
      ...
      return (0, import_jsx_runtime26.jsxs)(React35.Fragment, {
...
function CssAnimation(props) {
  ...
  const hasExited = React52.useRef(true);
  React52.useEffect(() => {
    if (requestedEnter && hasExited.current) {
      hasExited.current = false;
    }
  }, [requestedEnter]);
  const handleAnimationEnd = React52.useCallback((event) => {
...
var CssTransition = React53.forwardRef(function CssTransition2(props, forwardedRef) {
  const {
    children,
    className,
  ...
  const [isEntering, setIsEntering] = React53.useState(false);
  React53.useEffect(() => {
    if (requestedEnter) {
  ...
  const handleTransitionEnd = React53.useCallback((event) => {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-3SFG7GQV.js.map
